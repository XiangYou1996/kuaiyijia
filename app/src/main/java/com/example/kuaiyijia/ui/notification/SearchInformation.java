...
//                    System.out.println("3333333");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message_1 = intent.getStringExtra(MessageNotificationSendFragment.EXTRA_MESSAGE1);
        //String message_2 = intent.getStringExtra(tuisong.EXTRA_MESSAGE2);

        TextView textView_1 = findViewById(R.id.dingdanhao);
        //TextView textView_2 = findViewById(R.id.shouhuo1);
        textView_1.setText(message_1);
       //textView_2.setText("收获单位："+message_2);
        ...
        mqueding.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(SearchInformation.this, MessageNotificationSendFragment.class);
